...
pdf.cell(70, 15, txt="HAPPY families", ln=0, align="L") # ln=0 after,ln=1 new line, ln=2 below
pdf.cell(25, 4, txt="are all alike;", ln=2, align="L")   # L, R, C
pdf.cell(50, 20, txt="every unhappy family", ln=1, align="R")
pdf.cell(50, 20, txt="every unhappy family", ln=1, align="L") 
