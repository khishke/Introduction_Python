...
\title[Python Intro]{Introduction to Python & Applications of Python} 
...
\begin{enumerate}
    ...
    \item Elementary to Intermediate Python
        \begin{itemize}
            ...
            \end{itemize}            
            \item Applications topics: Visualizaiton, Automation, Webscraping, Files, ML/DL
        \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Following should help make the best out of the course:
            \begin{itemize}
                \item Doing homeworks in time
...
%------------------------------------------------
\section{Code editors: VScode, Jupyter notebook} 
\frame{\tableofcontents[currentsection]}
%------------------------------------------------
